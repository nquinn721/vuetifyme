...
export default CalendarBase.extend({
  ...
  methods: {
    eventColorFunction(e) {
      return typeof this.eventColor === 'function' ? this.eventColor(e) : e.color ? e.color : this.eventColor;
    },
    ...
    isEventForCategory(event, category) {
      return !this.categoryMode || category.categoryName === event.category || typeof event.category !== 'string' && category === null;
    },
