  ...
  methods: {
    ...
    getCategoryList: function getCategoryList(categories) {
      ...
      if (!this.noEvents) {
        ...
        if (!this.categoryHideDynamic || !this.categoryShowAll) {
          ...
          this.parsedEvents.forEach(function (ev) {
            ...
            if (typeof category !== 'string') {
              category = _this2.categoryForInvalid;
            }
            ...
            } else if (!_this2.categoryHideDynamic) {
        ...
        categories = categories.filter(function (v) {
    ...
    return h(component, {
      ...
      on: _objectSpread({}, this.$listeners, {
        'click:date': function clickDate(day) {
          if (_this3.$listeners.input) {
            _this3.$emit('input', day.date);
          }

          if (_this3.$listeners['click:date']) {
            _this3.$emit('click:date', day);
          }
        }
      }),
